...
//                     <div className="w-16 h-16 rounded-xl overflow-hidden shadow-lg flex-shrink-0 border-2 border-yellow-400/30 bg-gray-800">
//                         <img
//                             src={college.logo}
//                             alt={college.name}
...
//                             <span className="text-2xl font-bold text-yellow-400">{college.fees}</span>
...
//                             <span className="px-3 py-1 rounded-sm text-xs font-semibold bg-yellow-500/20 text-yellow-400 border border-yellow-500/30">
//                                 {college.ranking}
//                             </span>
//                         </div> */}
//                     </div>
...
//                 </div>
//                 <div className="bg-gray-800/50 rounded-lg p-3 text-center">
//                     {/* <Calendar className="w-4 h-4 mx-auto text-yellow-400 mb-1" /> */}
...
// // Updated CollegeCard.jsx
// import React from 'react';
// import { ArrowRight, MapPin, Users, Award, Calendar, GraduationCap, Globe } from 'lucide-react';

// const CollegeCard = ({ college, onKnowMore }) => {
...
//                     <div className="w-16 h-16 rounded-xl overflow-hidden shadow-lg flex-shrink-0 border-2 border-yellow-400/30 bg-gray-800">
//                         <img
//                             src={college.gallery?.logoUrl || '/default-college-logo.png'}
//                             alt={college.name}
//                             className="w-full h-full object-cover"
//                             onError={(e) => {
//                                 e.target.src = '/default-college-logo.png';
//                             }}
//                         />
//                     </div>
//                     <div className="flex-1 min-w-0">
...
//                             {college.name}
//                         </h3>
//                         <p className="text-sm text-gray-400 mb-2">{college.university}</p>
//                         <div className="flex items-center space-x-1 mb-3">
//                             <MapPin className="w-4 h-4 text-gray-400" />
//                             <span className="text-gray-400 text-sm">{formatAddress(college.address)}</span>
//                         </div>
...
//                     <Calendar className="w-4 h-4 mx-auto text-yellow-400 mb-1" />
//                     <p className="text-xs text-gray-400">Established</p>
//                     <p className="font-semibold text-white text-sm">{college.establishedYear || 'N/A'}</p>
//                 </div>
//                 <div className="bg-gray-800/50 rounded-lg p-3 text-center">
//                     <GraduationCap className="w-4 h-4 mx-auto text-yellow-400 mb-1" />
//                     <p className="text-xs text-gray-400">Programs</p>
//                     <p className="font-semibold text-white text-sm">{getStreamsCount(college.streams)}</p>
//                 </div>
//                 <div className="bg-gray-800/50 rounded-lg p-3 text-center">
//                     <Users className="w-4 h-4 mx-auto text-green-400 mb-1" />
//                     <p className="text-xs text-gray-400">Facilities</p>
//                     <p className="font-semibold text-white text-sm">{getFacilitiesCount(college.facilities)}</p>
//                 </div>
//                 <div className="bg-gray-800/50 rounded-lg p-3 text-center">
//                     <Globe className="w-4 h-4 mx-auto text-blue-400 mb-1" />
//                     <p className="text-xs text-gray-400">Type</p>
//                     <p className="font-semibold text-white text-sm">{college.type || 'Public'}</p>
//                 </div>
//             </div>
...
//                             <span className="text-xs text-gray-500">+{college.streams.length - 2} more</span>
//                         )}
//                     </div>
//                 </div>
//             )}
...
//             <button
//                 onClick={onKnowMore}
//                 className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-3 rounded-xl font-bold hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 flex items-center justify-center space-x-2 group-hover:shadow-lg group-hover:shadow-yellow-400/25"
//             >
//                 <span>Know more</span>
//                 <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
//             </button>
        ...
        <div className="bg-slate-1500 rounded-2xl p-4 sm:p-6 relative group hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.02] border border-gray-100 hover:border-yellow-400 overflow-hidden">
            ...
            <div className="relative z-10 mb-4 sm:mb-6">
                <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2 line-clamp-1">{college.university}</p>
                        <div className="flex items-center space-x-1 mb-2 sm:mb-3">
                            <MapPin className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0" />
                            <span className="text-gray-400 text-xs sm:text-sm line-clamp-1">{formatAddress(college.address)}</span>
                        </div>
            ...
            <div className="relative z-10 grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="bg-gray-800/50 rounded-lg p-2 sm:p-3 text-center">
                    {/* <Calendar className="w-3 h-3 sm:w-4 sm:h-4 mx-auto text-yellow-400 mb-1" /> */}
                    <p className="text-xs text-gray-400">Established</p>
                    <p className="font-semibold text-white text-xs sm:text-sm">{college.establishedYear || 'N/A'}</p>
                </div>
                <div className="bg-gray-800/50 rounded-lg p-2 sm:p-3 text-center">
                    {/* <GraduationCap className="w-3 h-3 sm:w-4 sm:h-4 mx-auto text-yellow-400 mb-1" /> */}
                    <p className="text-xs text-gray-400">Programs</p>
                    <p className="font-semibold text-white text-xs sm:text-sm">{getStreamsCount(college.streams)}</p>
                </div>
                <div className="bg-gray-800/50 rounded-lg p-2 sm:p-3 text-center">
                    {/* <Users className="w-3 h-3 sm:w-4 sm:h-4 mx-auto text-green-400 mb-1" /> */}
                    <p className="text-xs text-gray-400">Facilities</p>
                    <p className="font-semibold text-white text-xs sm:text-sm">{getFacilitiesCount(college.facilities)}</p>
                </div>
                <div className="bg-gray-800/50 rounded-lg p-2 sm:p-3 text-center">
                    {/* <Globe className="w-3 h-3 sm:w-4 sm:h-4 mx-auto text-blue-400 mb-1" /> */}
                    <p className="text-xs text-gray-400">Type</p>
                    <p className="font-semibold text-white text-xs sm:text-sm">{college.type || 'Public'}</p>
                </div>
            </div>
            ...
            {/* Enhanced Know More Button - Responsive for Mobile & Web */}
            <div className="relative z-10">
                {/* Mobile Button (Larger, more touch-friendly) */}
                <button
                    onClick={handleKnowMore}
                    className="sm:hidden w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 active:from-yellow-600 active:to-yellow-700 text-black font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl transform active:scale-95 touch-manipulation"
                >
                    <span className="text-base">Know More</span>
                    {/* <ArrowRight className="w-5 h-5" /> */}
                </button>

                {/* Desktop Button (Sleeker design) */}
                <button
                    onClick={handleKnowMore}
                    className="hidden sm:flex w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-black py-3 rounded-xl font-bold hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 items-center justify-center space-x-2 group-hover:shadow-lg group-hover:shadow-yellow-400/25 transform hover:scale-[1.02] active:scale-[0.98]"
                >
                    <span>Know More</span>
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
                </button>
