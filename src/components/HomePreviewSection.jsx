            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 text-center py-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button
                            onClick={() => navigateTo('jobs')}
                            className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white  px-8 py-3 rounded-full font-semibold hover:from-yellow-400 hover:to-orange-500 transition-all duration-300 flex items-center space-x-2 shadow-lg hover:shadow-yellow-400/25"
                        >
                        ...
                        <button
                            onClick={() => navigateTo('courses')}
                            className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-8 py-3 rounded-full font-semibold hover:from-yellow-400 hover:to-orange-400 transition-all duration-300 flex items-center space-x-2 shadow-lg hover:shadow-yellow-400/25"
                        >
