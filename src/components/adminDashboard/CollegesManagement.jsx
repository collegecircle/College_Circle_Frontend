...
import { Search, Plus, Edit, Trash2, Building, X, Eye } from "lucide-react";

const CollegesManagement = () => {
  const dispatch = useDispatch();
  const { list, status, error } = useSelector((state) => state.colleges);

  // Safely extract colleges and pagination info
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1 text-base">Manage college information and details</p>
          </div>
          <button
            onClick={handleAdd}
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[95vh] overflow-hidden flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="text-md font-semibold text-gray-900 border-b pb-2">Additional Details</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled={modalType === "view"}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100"
                      placeholder="e.g., Library, Sports Complex, Hostel"
                    />
                  </div>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="url"
                        value={formData.gallery.videoUrl}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            gallery: { ...formData.gallery, videoUrl: e.target.value },
                          })
                        }
                        disabled={modalType === "view"}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100"
                ...
                <div className="space-y-4">
                  <h4 className="text-md font-semibold text-gray-900 border-b pb-2">Streams & Courses</h4>
...
//       {/* Status Messages */}
//       {status === "loading" && (
//         <div className="bg-white rounded-lg shadow-sm border p-6 mb-6 flex justify-center items-center">
//           <div className="flex flex-col items-center">
//             <div className="w-10 h-10 border-4 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
//             <p className="mt-2 text-sm text-gray-600">Loading colleges...</p>
//           </div>
//         </div>
//       )}
//       {error && (
