...
import { registerUser, verifyUserOtp, loginUser } from '../adminDashboard/authSlice';
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            disabled={
                                ...
                                Object.keys(validateAll()).filter((key) => !["otp"].includes(key))
                                    .length > 0
                            }
                    ...
                    <div className="relative z-10 py-8 text-center text-white">
                        <div className="mb-6 relative">
                            <div className="relative w-32 h-32 mx-auto mb-4 rounded-full flex items-center justify-center backdrop-blur-sm shadow-xl">
                                <img src={Logo} alt="College Circle" className="w-full h-full object-contain" loading="lazy" />
                            </div>
                        </div>
