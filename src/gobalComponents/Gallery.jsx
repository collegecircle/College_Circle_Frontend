...
//                             }}
//                         >
//                             <div className="relative w-[320px] h-[180px] sm:w-[240px] sm:h-[135px] md:w-[360px] md:h-[202px] bg-white rounded-lg shadow-xl border-[2px] border-blue-500 overflow-hidden transition-transform duration-300 ease-out group-hover:scale-110">
//                                 <img
//                                     src={url}
//                                     alt="gallery"
    ...
    return (
        <div className="relative h-[500px] w-full overflow-hidden bg-gradient-to-br from-black via-gray-900 to-gray-800">
            ...
            <p className="absolute bottom-4 left-0 right-0 text-center text-lg md:text-xl text-gray-300 z-20 max-w-2xl mx-auto">
                Explore our curated collection of breathtaking images, showcasing the beauty and diversity of our world.
            </p>
        </div >
    );
};
