...
//   const carouselItems = items.length > 0 ? items : [
//     { id: 1, title: "Travel Reel", subtitle: "Adventure awaits", thumbnail: "/assets/student.jpeg", link: "https://www.instagram.com/p//", shortcode: "" },
//     { id: 2, title: "Food Stories", subtitle: "Culinary journey", thumbnail: "/assets/student.jpeg", link: "https://www.instagram.com/p/C9zjSY4yFE4/", shortcode: "C9zjSY4yFE4" },
//     { id: 3, title: "Lifestyle", subtitle: "Daily inspirations", thumbnail: "/assets/student.jpeg", link: "https://www.instagram.com/p/C7mEfWnpnA1/", shortcode: "C7mEfWnpnA1" },
//     { id: 4, title: "Tech Reviews", subtitle: "Latest gadgets", thumbnail: "/assets/student.jpeg", link: "https://www.instagram.com/p/C7eRhd3JBxa/", shortcode: "C7eRhd3JBxa" },
//     { id: 5, title: "Fitness Tips", subtitle: "Stay healthy", thumbnail: "/assets/student.jpeg", link: "#", shortcode: "" },
//     { id: 6, title: "Art & Design", subtitle: "Creative showcase", thumbnail: "/assets/student.jpeg", link: "#", shortcode: "" },
//     { id: 7, title: "Music Vibes", subtitle: "Rhythm & beats", thumbnail: "/assets/student.jpeg", link: "#", shortcode: "" },
//     { id: 8, title: "Nature", subtitle: "Wild & beautiful", thumbnail: "/assets/student.jpeg", link: "#", shortcode: "" },
//   ];
...
//                   <div
//                     key={item.id}
//                     className="group h-full flex flex-col justify-between bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white rounded-xl p-0 relative overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl border border-slate-700/50"
//                     style={{ width: `${100 / itemsPerView}%` }}
//                   >
//                     <div className="absolute inset-0 opacity-10">
//                       <div
...
const Carousel = ({ items = [] }) => {
  ...
  const carouselItems = items.length > 0 ? items : [
    ...
    { id: 2, title: "Food Stories", subtitle: "Culinary journey", thumbnail: "/assets/student.jpeg", link: "https://www.instagram.com/p/C9zjSY4yFE4/", shortcode: "C9zjSY4yFE4" },
    { id: 3, title: "Lifestyle", subtitle: "Daily inspirations", thumbnail: "/assets/student.jpeg", link: "https://www.instagram.com/p/C7mEfWnpnA1/", shortcode: "C7mEfWnpnA1" },
    { id: 4, title: "Tech Reviews", subtitle: "Latest gadgets", thumbnail: "/assets/student.jpeg-1518709268805-4e9042af2176?w=400&h=600&fit=crop", link: "https://www.instagram.com/p/C7eRhd3JBxa/", shortcode: "C7eRhd3JBxa" },
    { id: 5, title: "Fitness Tips", subtitle: "Stay healthy", thumbnail: "/assets/student.jpeg-1571019613454-1cb2f99b2d8b?w=400&h=600&fit=crop", link: "#", shortcode: "" },
    { id: 6, title: "Art & Design", subtitle: "Creative showcase", thumbnail: "/assets/student.jpeg-1541961017774-22349e4a1262?w=400&h=600&fit=crop", link: "#", shortcode: "" },
    { id: 7, title: "Music Vibes", subtitle: "Rhythm & beats", thumbnail: "/assets/student.jpeg-1493225457124-a3eb161ffa5f?w=400&h=600&fit=crop", link: "#", shortcode: "" },
    { id: 8, title: "Nature", subtitle: "Wild & beautiful", thumbnail: "/assets/student.jpeg-1441974231531-c6227db76b6e?w=400&h=600&fit=crop", link: "#", shortcode: "" },
  ];
            ...
            >
              {carouselItems
                ...
                .map((item) => (
                  <div
                    key={item.id}
                    className="group h-full flex flex-col justify-between text-white rounded-xl p-0 relative overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
                    style={{
                      width: `${100 / itemsPerView}%`,
                      backgroundImage: `url(${item.thumbnail || 'https://via.placeholder.com/400x600?text=Image+Not+Found'})`, // Fallback image
                      backgroundSize: 'cover',
                      backgroundPosition: 'center',
                      backgroundRepeat: 'no-repeat',
                      backgroundColor: '#1a202c', // Fallback background color
                      transition: 'background-image 0.3s ease-in-out' // Smooth background transition
                    }}
                    role="group" // Accessibility
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between p-6">
                      {/* Top section - Play button for reels */}
                        ...
                        {playingReelId === item.id && item.shortcode ? (
                          <div className="w-full h-full bg-black/80 rounded-lg flex items-center justify-center">
                            <iframe
                              ...
                              allowTransparency
                              allowFullScreen
                              title={`Instagram reel: ${item.title}`} // Accessibility
                            ></iframe>
                          </div>
                        ) : (
                          item.shortcode && (
                            <div
                              ...
                              onClick={() => handlePlayClick(item.id, item.shortcode)}
                              role="button"
                              aria-label={`Play reel: ${item.title}`} // Accessibility
                            >
                              <div className="bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-full p-4 transition-all duration-300 hover:scale-110">
                                <svg
                      ...
                      <div className="space-y-4">
                        ...
                        {/* <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600/90 to-blue-600/90 hover:from-purple-700/90 hover:to-blue-700/90 backdrop-blur-sm p-4 rounded-xl shadow-lg cursor-pointer transition-all duration-300 group-hover:scale-105 border border-white/20"
                          aria-label={`Follow ${item.title} on Instagram`}
                        >
                          <span className="text-white font-semibold text-sm md:text-base">Follow</span>
                          <svg
      ...
      <div className="flex justify-center my-4 space-x-3">
        {Array.from({ length: totalPages }).map((_, index) => (
          <button
            key={index}
            onClick={() => handleDotClick(index)}
            className={`h-2 rounded-full transition-all duration-300 focus:outline-none ${index === activeIndex
              ? "bg-[#fbbf24] to-blue-500 w-8 shadow-lg"
              : "bg-white  rounded-full h-2 w-2"
              }`}
            aria-label={`Go to page ${index + 1}`}
          />
        ))}
